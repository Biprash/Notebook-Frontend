...
function Note(): ReactElement {
    ...
    return (
        <>
            ...
            <main className="h-auto p-3 py-[80px] ml-[285px]">
                <button onClick={handleNewNoteFormClick} className="flex flex-col items-center justify-center rounded ">
                    ...
                    <p className="mt-4 text-sm text-center">Add Note</p>
                </button>

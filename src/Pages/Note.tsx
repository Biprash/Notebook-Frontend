...
function Note(): ReactElement {
    ...
    const handleNewNoteClick = (e: MouseEvent<HTMLButtonElement>) => {
        ...
        <>
            ...
            <div className="flex bg-gray-200">
                ...
                <div className="flex flex-wrap flex-1 p-2">
                    ...
                    <button onClick={handleNewNoteClick} className="bg-white rounded w-40 m-2 max-h-52 flex flex-col justify-center items-center">

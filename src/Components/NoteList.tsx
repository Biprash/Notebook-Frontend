...
function NoteList({}: Props): ReactElement {
    return (
        <div className="flex flex-wrap flex-1 p-2">

            <button className="bg-white rounded w-40 m-2 max-h-52 flex flex-col justify-center items-center">
            ...
            <div className="bg-white rounded w-40 m-2 max-h-52">
